#ifndef _CPPDRIVINGTERMS_CPP_
#define _CPPDRIVINGTERMS_CPP_
        ...
        for(iiter=sext_slice_index.begin();iiter!=sext_slice_index.end();iiter++)
        {
            ...
            if (md[iE].b3L)
            {
                for (jiter=sext_slice_index.begin(); jiter!=sext_slice_index.end(); jiter++) 
                {
                    ...
                    if (md[jE].b3L) 
                    {
                        dnux_dJx += md[iE].b3L*md[jE].b3L/(-16*PI)*pow(md[iE].rbetax*md[jE].rbetax, 3)*
                            (3*cos(fabs(md[iE].phix-md[jE].phix)-PI*nux)/sin(PI*nux) + cos(fabs(3*(md[iE].phix-md[jE].phix))-3*PI*nux)/sin(3*PI*nux));
                        dnux_dJy += md[iE].b3L*md[jE].b3L/(8*PI)*sqrt(md[iE].betax*md[jE].betax)*md[iE].betay*
                            (2*md[jE].betax*cos(fabs(md[iE].phix-md[jE].phix)-PI*nux)/sin(PI*nux) 
                            - md[jE].betay*cos(fabs(md[iE].phix-md[jE].phix)+2*fabs(md[iE].phiy-md[jE].phiy)-PI*(nux+2*nuy))/sin(PI*(nux+2*nuy))
                            + md[jE].betay*cos(fabs(md[iE].phix-md[jE].phix)-2*fabs(md[iE].phiy-md[jE].phiy)-PI*(nux-2*nuy))/sin(PI*(nux-2*nuy)));
                        dnuy_dJy += md[iE].b3L*md[jE].b3L/(-16*PI)*sqrt(md[iE].betax*md[jE].betax)*md[iE].betay*md[jE].betay*
                            (4*cos(fabs(md[iE].phix-md[jE].phix)-PI*nux)/sin(PI*nux) 
                            + cos(fabs(md[iE].phix-md[jE].phix)+2*fabs(md[iE].phiy-md[jE].phiy)-PI*(nux+2*nuy))/sin(PI*(nux+2*nuy)) 
                            + cos(fabs(md[iE].phix-md[jE].phix)-2*fabs(md[iE].phiy-md[jE].phiy)-PI*(nux-2*nuy))/sin(PI*(nux-2*nuy)));
                        // termSign = SIGN(md[iE].s - md[jE].s);
                        if (termSign) 
                        {
